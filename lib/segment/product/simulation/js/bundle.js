(function () {
	...
	*/
	...
	function add_geometry_to_scene$1(scene) {
	...
	function add_geometry_to_scene(scene) { // TEST GEOMETRY
	...
	camera.position.z = 100; // TODO respect bounding box
